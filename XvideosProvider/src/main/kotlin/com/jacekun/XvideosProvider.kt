...
class XvideosProvider : MainAPI() {
    ...
    override val mainPage = mainPageOf(
        ...
        Pair("$mainUrl/c/Fucked_Up_Family-81/", "Fucked Up Family"),
        Pair("$mainUrl/?k=trios&p=", "Threesome"),
        Pair("$mainUrl/c/Milf-19/", "Milf"),
        Pair("$mainUrl/lang/espanol/", "Spanish")
    )

    override suspend fun getMainPage(page: Int, request: MainPageRequest): HomePageResponse {
        val categoryData = request.data
        val categoryName = request.name
        val isPaged = categoryData.endsWith('/') || categoryData.endsWith('=')
